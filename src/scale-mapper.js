...
const dorian = [
  ...
  57, 58, 60, 62, 63, 65, 67, 69,
  62, 63, 65, 67, 69, 70, 72, 74,
...
const mixolydian = [
  36, 38, 40, 42, 43, 45, 46, 48,
  42, 43, 45, 46, 48, 50, 52, 54,
  46, 48, 50, 52, 54, 55, 57, 58,
  52, 54, 55, 57, 58, 60, 62, 64,
  57, 58, 60, 62, 64, 66, 67, 69,
  62, 64, 66, 67, 69, 70, 72, 74,
  67, 69, 70, 72, 74, 76, 78, 79,
  72, 74, 76, 78, 79, 81, 82, 84,
]

const aeolian = [
  36, 38, 39, 41, 43, 44, 46, 48,
  41, 43, 44, 46, 48, 50, 51, 53,
  46, 48, 50, 51, 53, 55, 56, 58,
  51, 53, 55, 56, 58, 60, 62, 63,
  56, 58, 60, 62, 63, 65, 67, 68,
  62, 63, 65, 67, 68, 70, 72, 74,
...
function msg_int(a) {
  if (inlet === 1) {
    ...
    // set color of 'mode select' LEDs
    for (let i = 36; i <= 43; i++) {
      const ledColor = i === a + 36 ? 127 : 122
